...
class extends Component {
    ...
    public function rules(): array
    {
        return [
            ...
            'name' => ['required', 'string', 'max:100', Rule::unique('work_stations', 'name')->where('process_id', $this->process_id)],
    ...
    public function save(): void
    {
        ...
        $validated['station_type_id'] = $this->station_type_id;
        ...
        $this->success('Work station created.', position: 'toast-bottom', redirectTo: route('work-stations.index'));
    }
...
<div>
    <x-header title="New work station" subtitle="Add a physical line or welding method." separator>
        <x-slot:actions>
            ...
            <div class="lg:col-span-8">
                <x-card title="Station details" shadow>
                    <div class="grid gap-4">
                        ...
                        <x-input label="Name" wire:model="name" icon="o-map-pin" placeholder="e.g. B5, or Station Spot" />
                    </div>
                </x-card>
            ...
            <div class="lg:col-span-4">
                <div class="sticky top-4 overflow-hidden rounded-2xl border border-base-300 bg-gradient-to-b from-base-200/60 to-base-100 px-6 py-6">
                    <div class="flex items-start gap-2 text-sm text-base-content/70">
                        ...
                        <p>The process and type determine what data is collected during inspections. Choose carefully — this cannot be easily changed later.</p>
                    </div>
                </div>
            </div>
        </div>
